...
public class Main extends JFrame {
    ...
    public Main() {
        ...
        JRadioButton Fiji = new JRadioButton("Hak",false);
        Fiji.setBounds(103,65,20,20);
        cp.add(Fiji);
        ...
        jb.addActionListener(arg0 -> {
            ...
            if (Fiji.isSelected()){
                for (int x = 0; x < s.length(); x++) {
                    int l = s.charAt(x) - Integer.parseInt(nm.getText()) - 2;
                    sb.append((char) l);
        ...
        JOptionPane.showMessageDialog(null,"Made By Fengli");
        setVisible(true);
    }
